...
// Current slide and products per page
const currentSlide = ref(0);
const productsPerPage = ref(4);

// Product data
const products = [
  { id: 1, name: 'Floral', price: 29.99, rating: 4.5, image: '/src/assets/Image 1.jpg', discount: 20 },
  { id: 2, name: 'Oriental', price: 39.99, rating: 4.2, image: '/src/assets/Image2.jpg', discount: 15 },
  { id: 3, name: 'Woody', price: 19.99, rating: 4.7, image: '/src/assets/Image3.jpg', discount: 10 },
  { id: 4, name: 'Fresh', price: 49.99, rating: 5.0, image: '/src/assets/Image4.jpg', discount: 25 },
  { id: 5, name: 'Ocean', price: 59.99, rating: 3.5, image: '/src/assets/Image5.jpg', discount: 0 },
  { id: 6, name: 'Citrus', price: 24.99, rating: 3.7, image: '/src/assets/Image6.jpg', discount: 30 },
  { id: 7, name: 'Amber', price: 34.99, rating: 4.5, image: '/src/assets/Image7.jpg', discount: 10 },
  { id: 8, name: 'Musk', price: 44.99, rating: 4.5, image: '/src/assets/Image8.jpg', discount: 20 },
];

// Calculate total slides
const totalSlides = computed(() => Math.ceil(products.length / productsPerPage.value));

// Products to display in the current slide
